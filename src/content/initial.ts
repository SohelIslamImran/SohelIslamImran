...
export const INITIAL_PORTFOLIO_CONTENT: PortfolioContent = {
	...
	experience: [
		{
			...
			summary:
				"Lead full-stack architecture and delivery across Kuno’s enterprise learning product, internal tooling, and platform operations.",
			highlights: [
		...
		},
		{
			...
			highlights: [
				"Delivered secure onboarding, matching, AI-assisted content, and localized product workflows.",
			],
		...
		},
		{
			...
			summary:
				"Developed mobile learning experiences and carried shared product behavior across native and web surfaces.",
			highlights: [
				"Built React Native and Expo product capabilities with attention to platform behavior and release quality.",
			],
	...
	projects: [
		{
			...
			description:
				"Generalized public account of product architecture across identity, programs, pathways, matching, localization, and delivery.",
			year: "2023—now",
		...
		},
		{
			...
			description:
				"A focused CLI with color selection, timers, focus-aware pause and resume, and automatic centering.",
			year: "2025—now",
			role: "Creator and maintainer",
			status: "Maintained",
		...
		},
		{
			...
			slug: "tailsync",
			summary:
				"A native iOS app for syncing photos, videos, and files to personal Tailscale Taildrop devices.",
			description:
				"Transfers stay inside the user’s tailnet, with per-device history, duplicate prevention, retry handling, share-sheet support, and conservative deletion defaults.",
			year: "2026",
			role: "Creator",
			status: "Experimental",
		...
		},
		{
			...
			description:
				"A macOS menu-bar app and Android client use ADB port forwarding and local streaming, with no internet connection required.",
			year: "2025—2026",
			role: "Creator",
			status: "Prototype",
	...
	capabilities: [
		...
		},
		{
			...
			description:
				"Cross-platform product work and native integrations that respect platform behavior.",
	...
	resume: {
		...
		summary:
			"Five years across enterprise B2B products, mobile applications, open source, and developer tooling.",
	},
	story: {
		eyebrow: "Personal field note / Long-form",
		title: "From a phone in Bangladesh to full-stack engineering.",
		intro:
			"A story about starting without a computer, learning in public, and following small evidence until it became a career.",
		quote:
		...
		chapters: [
			...
			{
				id: "02",
				eyebrow: "The first proof",
				title: "An unpaid internship was still a doorway.",
				paragraphs: [
					"Roughly six months after the course, I earned an internship with a US-based company. It gave me a real codebase, real expectations, and responsibility to make my work useful to others.",
		...
		sourceHref:
			"https://www.linkedin.com/posts/sohelislamimran_fromzerotoengineer-careerjourney-selftaught-activity-7341153854459125762-pW02",
	},
	travel: {
		eyebrow: "Field notes / Atlas in progress",
		title: "The world is the next system I want to understand.",
		intro:
			"A living record of places, conversations, small observations, and the work that travels with me. No bucket list. No invented pins.",
